...
const Booking = () => {
    ...
    return (
        <div className="pb-5 ">
            <h1 style={{color:"#F46150"}} className="pt-5 pb-5">Now Book your Trainer</h1>
            <div className="row d-flex">
                <div className="col-lg-5 col md-6 col-sm-12">
                    ...
                    <div className="card-footer">
                        <Link to="">
                                <button  className="btn border" style={{color:"black"}}>Booking {sd?.name}</button>
                        </Link>
                    </div>
                </div>
                </div>
